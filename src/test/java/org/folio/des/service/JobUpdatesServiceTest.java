...
class JobUpdatesServiceTest extends BaseTest {
  ...
  @Autowired private JobUpdatesService updatesService;
  ...
  void updateJob() {
    ...
    Assertions.assertAll(
      () -> assertEquals(job.getBatchStatus(), savedJob.getBatchStatus()),
      ...
      () -> assertEquals(job.getStartTime(), savedJob.getStartTime()),
      () -> assertEquals(job.getEndTime(), savedJob.getEndTime()),
      () -> assertEquals(job.getFiles(), savedJob.getFiles()),
